...
var images=["1.jpg","2.jpg","3.jpg","4.jpg","5.jpg","6.jpg","7.jpg","8.jpg","9.jpg"]
        function inc()
        {
            ...
            {
                indval=0;
            document.getElementById("header").style.backgroundImage="url(../ASSET/Images/satellite/"+images[indval]+")";
            }
            else
            {
                document.getElementById("header").style.backgroundImage="url(../ASSET/Images/satellite/"+images[indval]+")";
        ...
        function openImg(pic,name,info)
        {
            ...
            document.getElementById("subWindoImg").src='../ASSET/Images/satellite/'+pic+".jpg"
